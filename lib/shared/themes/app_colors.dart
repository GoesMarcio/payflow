...
class AppColors {
  ...
  static final primaryLight = Color(0xFFFFC380);
  ...
  static final white0 = Color(0xFFFFFFFF).withOpacity(0);
  static final white80 = Color(0xFFFFFFFF).withOpacity(0.8);
  static final white94 = Color(0xFFFFFFFF).withOpacity(0.9429);
  static final white100 = Color(0xFFFFFFFF).withOpacity(1);
}
